...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, db_index=True, help_text=' (Encryption: RSA local)', max_length=71),
        ),
        migrations.AlterField(
            model_name='historicalscreeningpartone',
            name='initials',
        ...
        migrations.AlterField(
            ...
            name='hospital_identifier',
            field=django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, help_text=' (Encryption: RSA local)', max_length=71, unique=True),
        ),
        migrations.AlterField(
            model_name='subjectscreening',
            name='initials',
