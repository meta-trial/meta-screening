    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hiv_pos', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=5, verbose_name='Is the patient HIV positive')),
                ('art_six_months', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, verbose_name='Has the patient been on anti-retroviral therapy for at least 6 months')),
                ('on_rx_stable', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, verbose_name='Is the patient considered to be stable on treatment (in regular attendance for care)')),
                ('lives_nearby', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, verbose_name='Is the patient living within the catchment population of the facility')),
                ('staying_nearby', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, verbose_name='Is the patient planning to remain in the catchment area for at least 6 months')),
                ...
                ('congestive_heart_failure', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient have congestive heart failure requiring pharmacologic therapy')),
                ('liver_disease', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='Evidence of chronic liver disease: Jaundice, pruritus, hepatomegaly, ascites, spider naevi and flapping tremors.', max_length=15, verbose_name='Is there clinical evidence of liver disease')),
                ('alcoholism', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='Evidence of alcoholism or acute alcohol intoxication: flushing, amnesia, mental confusion, nausea or vomiting, slurred speech, dehydration, dry skin and brittle hair.', max_length=15, verbose_name='Does the patient have any evidence of alcoholism or acute alcohol intoxication')),
                ('acute_metabolic_acidosis', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient have any signs or symptoms of acute metabolic acidosis (lactic acidosis and/or diabetic ketoacidosis)')),
                ('renal_function_condition', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient have any acute condition which can alter renal function including: dehydration, severe infection or shock')),
                ('tissue_hypoxia_condition', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='Including: decompensated heart failure, respiratory failure, recent myocardial infarction or shock', max_length=15, verbose_name='Does the patient have any acute condition which can cause tissue hypoxia')),
                ('acute_condition', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient have any acute condition requiring immediate hospital care/admission')),
                ('metformin_sensitivity', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='For example: Magnesium stearate, sodium carboxymethylcellulose, hypromellose', max_length=15, verbose_name='Does the patient have any known hypersensitivity to metformin or any excipients associated with its preparation')),
